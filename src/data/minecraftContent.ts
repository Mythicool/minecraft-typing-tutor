...
export const typingContent = {
  beginner: {
    ...
    sentences: [
      'I dig dirt with my hands.',
      'The pig runs in the grass.',
      'Stone is hard to break.',
      'Wood comes from trees.',
      'Coal burns in the furnace.',
      'Iron makes strong tools.',
      'Gold is rare and shiny.',
      'Sheep give wool for beds.',
      'Cows drop meat and leather.',
      'Chickens lay eggs for food.',
      'Water flows down the hill.',
      'Lava is hot and dangerous.',
      'The sun rises in the east.',
      'Night brings scary mobs.',
      'I craft tools to survive.',
      'Building a house is fun.',
      'Farming helps me get food.',
      'Cooking meat makes it safe.',
      'Torches light up dark caves.',
      'Chests store my items safely.',
    ],
  },
  ...
  intermediate: {
    ...
    sentences: [
      'Diamond ore is found deep underground.',
      'Redstone powers complex contraptions.',
      'Enchanting tables improve your gear.',
      'Zombies spawn during the dark night.',
      'Skeletons shoot arrows from afar.',
      'Creepers explode when they get close.',
      'Endermen teleport around the world.',
      'Villagers trade emeralds for goods.',
      'The nether is a dangerous dimension.',
      'Blazes guard nether fortresses well.',
      'Ghasts float and shoot fireballs.',
      'Brewing stands create useful potions.',
      'Experience points help with enchanting.',
      'Adventure mode limits block breaking.',
      'Survival mode tests your skills.',
      'Creative mode gives unlimited resources.',
      'Hardcore mode means permanent death.',
      'Exploration reveals hidden treasures.',
      'Mountains contain valuable ores.',
      'Oceans hide underwater monuments.',
    ],
  },
